...
queryYoutube = do
  ...
  let request = setQueryString [("part", Just "snippet"), ("channelId", Just "UC6cqazSR6CnVMClY0bJI0Lg"), ("maxResults", Just "1"), ("order", Just "date"), ("type", Just "video"), ("key", Just "<youtube api key>")] initReq
